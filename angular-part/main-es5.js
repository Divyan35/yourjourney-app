        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthenticationService = /** @class */ (function () {
                ...
                AuthenticationService.prototype.registerTraveller = function (traveller) {
                    ...
                    return this.http.post(this.apiURL + 'traveller/register', traveller, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
                };
                AuthenticationService.prototype.authenticateTraveller = function (traveller) {
                    var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
                    headers.append('Content-Type', 'application/json');
                    return this.http.post(this.apiURL + 'traveller/authenticate', traveller, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) { return res.json(); }));
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TraveltimeDataService = /** @class */ (function () {
                ...
                TraveltimeDataService.prototype.gettravellingdata = function () {
                    return this.http.get(this.apiURL + 'traveller/gettime').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
                };
                TraveltimeDataService.prototype.travellingdata = function (traveldata) {
                    var headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
                    headers.append('Content-Type', 'application/json');
                    return this.http.post(this.apiURL + 'traveller/traveldata', traveldata, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
                };
                TraveltimeDataService.prototype.deletedata = function (id) {
                    return this.http.delete('traveller/traveldelete/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res.json(); }));
                };
                    ...
                    this.traveltimeDataService.gettravellingdata()
                        ...
                        try {
                            for (var _b = __values(_this.Traveltime), _c = _b.next(); !_c.done; _c = _b.next()) {
                                ...
                                _this.usersource = _this.source.toLowerCase();
                                _this.userdestination = _this.destination.toLowerCase();
                                if (item.source == _this.usersource && item.destination == _this.userdestination) {

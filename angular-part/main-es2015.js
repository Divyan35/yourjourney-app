...
let AuthenticationService = class AuthenticationService {
    constructor(http, httpClient) {
        ...
        this.apiURL = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_6__["environment"].apiUrl;
    }
    registerTraveller(traveller) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.apiURL + 'traveller/register', traveller, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => res.json()));
    }
    authenticateTraveller(traveller) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.apiURL + 'traveller/authenticate', traveller, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => res.json()));
    }
    getInfo() {
        this.getToken();
...
let TraveltimeDataService = class TraveltimeDataService {
    constructor(http) {
        this.http = http;
        this.apiURL = _environments_environment_prod__WEBPACK_IMPORTED_MODULE_4__["environment"].apiUrl;
    }
    gettravellingdata() {
        return this.http.get(this.apiURL + 'traveller/gettime').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
    travellingdata(traveldata) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.apiURL + 'traveller/traveldata', traveldata, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
    deletedata(id) {
        return this.http.delete('traveller/traveldelete/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
};
TraveltimeDataService.ctorParameters = () => [
    { type: _angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"] }
];
...
let AdminComponent = class AdminComponent {
    constructor(traveltimeDataService) {
...
let LoginComponent = class LoginComponent {
    constructor(authenticationService, router, flashMessage) {
...
let RegistrationComponent = class RegistrationComponent {
    constructor(ValidationService, flashMessage, authenticationService, router) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".bg\r\n{\r\n    background-color: azure;\r\n}\r\ntd\r\n{\r\nbackground-color:whitesmoke;\r\n}\r\nlabel\r\n{\r\n    background-color:#bdd7db ;\r\n}\r\n/*# sourceMappingURL=data:application/json;base64, */");
...
let TravelportalComponent = class TravelportalComponent {
    constructor(traveltimeDataService, flashMessage) {
        this.traveltimeDataService = traveltimeDataService;
        this.flashMessage = flashMessage;
        this.Traveltime = [];
        this.Filtime = [];
    ...
    getdata() {
        ...
        this.traveltimeDataService.gettravellingdata()
            ...
            for (let item of this.Traveltime) {
                ...
                this.usersource = this.source.toLowerCase();
                this.userdestination = this.destination.toLowerCase();
                if (item.source == this.usersource && item.destination == this.userdestination) {
...
TravelportalComponent.ctorParameters = () => [
    { type: src_app_services_traveltime_data_service__WEBPACK_IMPORTED_MODULE_2__["TraveltimeDataService"] },
    { type: angular2_flash_messages__WEBPACK_IMPORTED_MODULE_4__["FlashMessagesService"] }
];
...
const environment = {
    production: true,
    apiUrl: "https://yourjourney-app.herokuapp.com/"
};
